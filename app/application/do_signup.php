...
{
    return sendPush($user_login_id,"Bienvenido a bordo {$names}, estamos felices de que te hayas registrado en Libertad en Automático",GranCapital\CatalogNotification::ACCOUNT);
}
